                    ...
                    <div class="auto-container">
                        <div class="inner-container">
                            ...
                            <footer class="footer-area default-style bg-img"
                                style="margin-right: 45px;text-align: center;flex: auto;margin-bottom: 28px;">
                                <div class="widget-social-icons">
                                    <a href="{{ $footer_[0]->red_social_facebook }}"><i class="fa fa-facebook"></i></a>
                                    <a href="{{ $footer_[0]->red_social_instagram }}"><i
                    ...
                    <div class="header-align">
                        <div class="header-navigation-area d-none d-xl-block">
                            <ul class="main-menu nav position-relative">
                                <li class="submenu_monitor"><a href="/">Inicio</a></li>
                                ...
                                <?php if (Auth::check()) { ?>
                                <li class="has-submenu submenu_monitor"><a href="javascript:return false"><i
                                            class="fa fa-power-off" style="margin-right: 10px;"></i>LOGOUT</a>
                                    <ul class="submenu-nav">
                                ...
                                <button class="btn-cart cart-icon submenu_monitor"
                                    onclick="window.location.href='/admin/homes'">
                                    <span class="cart-count">Iniciar Session</span>
                        ...
                        <div class="header-action-area">
                            <div class="header-action-cart d-none d-xl-block">
                                ...
                                <?php if (Auth::check()) { ?>
                                <li class="has-submenu"><a href="javascript:return false"><i class="fa fa-power-off"
