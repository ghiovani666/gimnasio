...
<main class="main-content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title-content content-style2">
                        <h2 class="title"><span style="color:{{$rowData_[3]->superior_titulo1_color}} !important;">{{$rowData_[3]->superior_titulo1}}</span></h2>
                        <div class="desc">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-5">
                    <div class="divider-content">
                        <h2 class="title" style="color:{{$rowData_[3]->superior_titulo1_color}} !important;">{{$rowData_[3]->inferior_titulo}}</h2>
            ...
            @foreach($result as $key => $value)
                <div class="row" style="margin-bottom: 45px;">
                    <div class="col-sm-12 text-center">
                        <h2 class="section_header grey" style="color:{{$rowData_[3]->superior_titulo1_color}} !important;">{{ $key }}</h2>
                    </div>
                </div>
                <div class="row">
    ...
    <section class="light_section section_padding_75" style="margin-top: 45px;margin-bottom: 45px;text-align: center;">
        <div class="container">
            <h2 class="title" style="color:{{$rowData_[3]->superior_titulo1_color}} !important;">Si te interesa este servicio contacta con nosotros ahora</h2>
