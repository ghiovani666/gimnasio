                                ...
                                <div class="card card-primary">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group ShowHideHeader">
                                            ...
                                            <input type="text" class="form-control" name="txt_info_titulo_heder" required>
                                        </div>
                                        <div class="form-group ShowHideHeader">
                                            <label for="txt_header_descripcion">Descripción Header</label>
                                            <input type="text" class="form-control" name="txt_info_titulo_descripcion" required>
                                        </div>
                                        ...
                                        <div class="form-group txt_url_link">
