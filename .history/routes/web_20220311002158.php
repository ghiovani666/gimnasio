...
*/
    ...
    Route::get('/viewServicioInfo/{id}',   'Web\ServicioController@viewServicioInfo')->name('viewServicioInfo');
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        //::::::::::::::::::::::: CONTROLLER NOVEDAD ::::::::::::::::::::::::::
        Route::get('/novedadEvento',            'Admin\NovedadController@novedadEvento');
        Route::get('/novedadBono',              'Admin\NovedadController@novedadBono');
        Route::get('/novedadNoticia',           'Admin\NovedadController@novedadNoticia');
        Route::get('/novedadReto',              'Admin\NovedadController@novedadReto');
        Route::post('/saveServiciosNovedad',    'Admin\NovedadController@saveServiciosNovedad');
        Route::post('/imagenServiciosNovedad',  'Admin\NovedadController@imagenServiciosNovedad');
