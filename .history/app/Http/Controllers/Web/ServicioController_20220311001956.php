...
class ServicioController extends Controller
{
    ...
    public function viewServicioFitness(Request $request){
        $rowData_ = DB::table('menu_category')->leftJoin('products', 'menu_category.id_cat', '=', 'products.cat_id')->where('menu_category.id_cat', '=',$request->id)->get();
    	return view('web.layouts.pages.servicio.info_servicio.infoservicio')->with(compact('rowData_'));
    }
