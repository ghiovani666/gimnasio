          ...
          if(file_exists(str_replace('/template_admin/', 'template_admin/',  $url_imagen[0]->url_image))){
            ...
            $result  =  DB::table('web_servicio_descripcion')
              ...
              ->update([
                ...
                'info_url_image' => '/template_admin/img/'.$filename, 
                'updated_at' =>date("Y-m-d H:i:s")
                
              ]); 

              return json_encode(['data' => 'Se registro correctamente!','state' => 'ok','src' => '/template_admin/img/'.$filename]);

          }else{
            var_dump($request->txt_info_titulo_heder);
            // $result  =  DB::table('web_servicio_descripcion')
            //   ->where("id_descripcion",$request->txt_id_descripcion)
            //   ->update([
